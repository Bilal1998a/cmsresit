...
const url = `https://www.bilalahmed.no/cms/wp-json/wp/v2/posts/${id}?_embed=wp:featuredmedia`;
https://www.bilalahmed.no/cms/wp-json/wp/v2/posts?_embed=wp:featuredmedia&per_page=10
